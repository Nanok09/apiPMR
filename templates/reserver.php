...
<div class="container">
    ...
    <h1 class="font-custom-blue">Réserver : <?php echo $infos["nom"] ?></h1>
    <div class="card">
        ...
        <div class="card col-12 col-sm-8 col-md-6 p-0">
            <div class="card-body bg-custom-blue font-custom-light rounded">
                <form id="add_reservation">
                    ...
                    <div class="form-group row">
                        <label class="col-6"><i class="fas fa-fw fa-user-friends"></i> Nombre de personnes</label>
                        <input class="col-6" type="number" min="1" max="100" name="nb_personnes" required>
                    </div>
